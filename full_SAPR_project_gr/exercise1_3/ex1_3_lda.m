...
title('First two features Visualization');
...
figure(4)
hold on;
plot(meas_recovered(iris_labels==0, 1), meas_recovered(iris_labels==0, 2), 'bo');
plot(meas_recovered(iris_labels==1, 1), meas_recovered(iris_labels==1, 2), 'rs');
plot(meas_recovered(iris_labels==2, 1), meas_recovered(iris_labels==2, 2), 'go');
xlabel('Dimension 1');
ylabel('Dimension 2');
title('LDA Projection of Fisher Iris Dataset');
hold off;
...
title('LDA Projection of Fisher Iris Dataset along the primary LDA component');
hold off;
